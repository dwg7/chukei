...
- **This session did not comment on or close GitHub issue #1** — the code/doc changes are done and pushed (see below), but posting to the issue itself needs hfu's go-ahead first, per this session's operating rules around acting on public-repo state.
