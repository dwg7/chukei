...
\`\`\`
https://dwg7.github.io/spiccato/#q=catalog=${STARS_OPTGEO_CATALOG_URL}&type=martin&basemap=positron&bbox=2.28,48.83,2.4,48.89&name=パリ
\`\`\`

> [地図](https://dwg7.github.io/spiccato/#q=catalog=${STARS_OPTGEO_CATALOG_URL}&type=martin&basemap=positron&bbox=2.28,48.83,2.4,48.89&name=パリ)を用意しました。(以下同じく省略)
